...
public class WordData {
    ...
    public String[] easyWord = {"Anomaly","Equivocal","Lucid","Precipitate","Assuage","erudite","opaque","prodigal","enigma","fervid","placate","zeal","abstain",
            "audacious","desiccate","gullible","laudable","pedant","vacillate","adulterate","capricious","engender","homogenous","loquacious","pragmatic "};
    public String[] easyMeaning = {"Something that is unusual or unexpected","Not easily understood or explained","Very clear and easy to understand",
